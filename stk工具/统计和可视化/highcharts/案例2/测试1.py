...
if __name__ == '__main__':
	...
	from 获取数据模版1 import get_days_wencai
	...
	# ]
	a=get_days_wencai(start='20230101',end='20231125',txt="涨停,证券板块")
	...
	for i in range(len(a['date'])):
		...
		try:
			out.append([timestamp,a['line'][str(0)][i]])
