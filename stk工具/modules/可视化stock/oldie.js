...
(function(c) {
    ...
    function p(c, q, e, D) {
        c.hasOwnProperty(q) || (c[q] = D.apply(null, e), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: q,
                module: c[q]
            }
    ...
    p(c, "Extensions/Oldie/VMLRenderer3D.js", [c["Core/Axis/Axis.js"], c["Core/DefaultOptions.js"], c["Extensions/Oldie/VMLAxis3D.js"]], function(c, q, e) {
        var x = q.setOptions;
        return function() {
            function l() {}
    ...
    p(c, "Extensions/Oldie/Oldie.js", [c["Core/Chart/Chart.js"], c["Core/Color/Color.js"], c["Core/Globals.js"], c["Core/DefaultOptions.js"],
        c["Core/Pointer.js"], c["Core/Renderer/RendererRegistry.js"], c["Core/Renderer/SVG/SVGElement.js"], c["Core/Renderer/SVG/SVGRenderer.js"], c["Core/Utilities.js"], c["Extensions/Oldie/VMLRenderer3D.js"]
    ], function(c, q, e, p, l, g, y, h, m, Q) {
        var x = q.parse,
            u = e.deg2rad,
            k = e.doc;
        q = e.noop;
        ...
        var R = m.isArray,
            ...
            t = m.pInt,
            S = m.uniqueKey;
        M().global.VMLRadialGradientURL = "http://code.highcharts.com/10.0.0/gfx/vml-radial-gradient.png";
        k && !k.defaultView && (e.getStyle = m.getStyle = function r(b, d) {
            var c = {
                width: "clientWidth",
                height: "clientHeight"
            }[d];
            ...
            "opacity" === d && (d = "filter");
            if (c) return b.style.zoom = 1, Math.max(b[c] - 2 * r(b, "padding"), 0);
        ...
        E || (D(y, "afterInit", function() {
            "text" === this.element.nodeName && this.css({
                position: "absolute"
            })
        }), l.prototype.normalize = function(a, b) {
            a = a || v.event;
            a.target || (a.target = a.srcElement);
            b || (this.chartPosition = b = this.getChartPosition());
            return w(a, {
                chartX: Math.round(Math.max(a.x, a.clientX - b.left)),
                chartY: Math.round(a.y)
            })
        ...
        }), e.addEventListenerPolyfill = function(a, b) {
            function d(a) {
            ...
            docMode8: k && 8 === k.documentMode,
            init: function(a, b) {
                var d = ["<", b, ' filled="f" stroked="f"'],
                    c = ["position: ", "absolute", ";"],
                    f = "div" === b;
            ...
            setSpanRotation: function() {
                var a = this.rotation,
                    ...
                    d = Math.sin(a * u);
                z(this.element, {
                    filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -d, ", M21=", d, ", M22=", b, ", sizingMethod='auto expand')"].join("") : "none"
                })
            },
            getSpanCorrection: function(a, b, d, c, f) {
                var r = c ? Math.cos(c * u) : 1,
                    e = c ? Math.sin(c * u) : 0,
                ...
                this.yCorr -= r * b * (c ? A ? d : 1 - d : 1);
                f && "left" !== f && (this.xCorr -= a * d * (0 > r ? -1 : 1), c && (this.yCorr -= J * d * (0 > e ? -1 : 1)), z(this.element, {
                    textAlign: f
                }))
            },
            ...
            clip: function(a) {
                ...
                if (a) {
                    ...
                    a = a.getCSS(b)
                } else b.destroyClip && b.destroyClip(), a = {
            ...
            shadow: function(a, b, d) {
                ...
                if (a) {
                    ...
                    for (f = 1; 3 >= f; f++) {
                        ...
                        d && (g.cutOff = m + 1);
                        l = ['<stroke color="', a.color || "#000000", '" opacity="', n * f, '"/>'];
            ...
            dashstyleSetter: function(a, b, d) {
                (d.getElementsByTagName("stroke")[0] || F(this.renderer.prepVML(["<stroke/>"]), null, null, d))[b] = a || "solid";
                this[b] = a
            },
            ...
            "fill-opacitySetter": function(a, b, d) {
                F(this.renderer.prepVML(["<", b.split("-")[0], ' opacity="', a, '"/>']), null, null, d)
            },
            opacitySetter: q,
        ...
        }, c["stroke-opacitySetter"] = c["fill-opacitySetter"], e.VMLElement = c = p(y, c), c.prototype.ySetter = c.prototype.widthSetter = c.prototype.heightSetter = c.prototype.xSetter, c = {
            Element: c,
            isIE8: -1 < v.navigator.userAgent.indexOf("MSIE 8.0"),
            init: function(a, b, d) {
                this.crispPolyLine = h.prototype.crispPolyLine;
                this.alignedObjects = [];
                var c = this.createElement("div").css({
                    position: "relative"
                });
                var f = c.element;
                ...
                return w(f, {
                    ...
                    getCSS: function(a) {
                        var b = a.element,
                            d = b.nodeName,
                            c = a.inverted,
                            f = this.top - ("shape" === d ? b.offsetTop : 0),
                            e = this.left;
                        b = e + this.width;
                        var r = f + this.height;
                        f = {
                            clip: "rect(" + Math.round(c ? e : f) + "px," + Math.round(c ? r : b) + "px," + Math.round(c ? b : r) + "px," + Math.round(c ? f : e) + "px)"
                        };
                        !c && a.docMode8 && "DIV" === d && w(f, {
                            width: b + "px",
                            height: r + "px"
                        });
                        return f
            ...
            color: function(a, b, d, c) {
                ...
                if (h) {
                    var g, m, n = a.linearGradient || a.radialGradient,
                        l = void 0,
                        p = void 0,
                        q = void 0,
                        t = void 0,
                    ...
                    var B = [],
                        D = function() {
                            r = ['<fill colors="' + B.join(",") + '" opacity="', v, '" o:opacity2="', u, '" type="', h, '" ', z, 'focus="100%" method="any" />'];
                            F(f.prepVML(r), null, null, b)
                        };
                    l = a[0];
                    p = a[a.length - 1];
                    ...
                    if ("fill" === d)
                        if ("gradient" === h) l = n.x1 || n[0] || 0, p = n.y1 || n[1] || 0, q = n.x2 || n[2] || 0, t = n.y2 || n[3] || 0, z = 'angle="' + (90 - 180 * Math.atan((t - p) / (q - l)) / Math.PI) + '"', D();
                        else {
                            d = n.r;
                            var E = 2 * d,
                                G = 2 * d,
                            ...
                            n = function() {
                                ...
                                z = 'src="' + M().global.VMLRadialGradientURL + '" size="' + E + "," + G + '" origin="0.5,0.5" position="' + H + "," + I + '" color2="' + y + '" ';
                                D()
                            };
                            c.added ? n() : c.onAdd = n;
                            k = w
            ...
            invertChild: function(a, b) {
                ...
                z(a, {
                    flip: "x",
                    left: t(b.width) - (e ? t(e.top) : 1) + "px",
                    top: t(b.height) - (e ? t(e.left) : 1) + "px",
                    rotation: -90
                });
            ...
            symbols: {
                ...
                rect: function(a, b, c, e, f) {
                    return h.prototype.symbols[H(f) && f.r ? "callout" : "square"].call(0, a, b, c, e, f)
                }
            }
